...
parser.add_argument('-w', dest='min_workers_per_shift', default=0, help='The minimum number of workers on all shifts.', type=int)
parser.add_argument('-p', dest='min_shifts_filled_percent', action=PercentageValidatorAction, default=0, help='The percentage of shifts the model has to fill.', type=float)
